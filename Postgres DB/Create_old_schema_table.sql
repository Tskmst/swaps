CREATE TABLE sec_cumulative_equities_old (
    ...
    call_amount_leg_1 NUMERIC,
    call_amount_leg_2 NUMERIC,
    call_currency_leg_1 VARCHAR(255),
    call_currency_leg_2 VARCHAR(255),
    put_amount_leg_1 NUMERIC,
    put_amount_leg_2 NUMERIC,
    put_currency_leg_1 VARCHAR(255),
    put_currency_leg_2 VARCHAR(255),
    ...
    settlement_location_leg_1 VARCHAR(255),
    settlement_location_leg_2 VARCHAR(255),
