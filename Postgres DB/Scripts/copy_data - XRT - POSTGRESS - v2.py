...
db_url = 'postgresql://postgres:s3cUr3PW@localhost:5432/xrt_data'
reference_file_path = 'F:/AMC/Postgres/Scripts/XRT_reference_file_POSTGRES.txt'
base_folder = 'F:/AMC/Equities'
unique_id_column = 'Underlier ID-Leg 1'
unique_id_value = "US78464A7147"
